...
const x = class x {
  ...
  static loadArrayBuffer(r) {
    return new Promise((t, a) => {
      fetch(r).then((e) => {
        !e.ok || e.headers.get("Content-Type") == "text/html" ? a(e.statusText) : e.arrayBuffer().then((i) => t(i)).catch((i) => console.warn(i));
      }).catch((e) => {
        console.warn(e), a(e);
      });
    });
  ...
  static loadAllDictUrls() {
    const t = Object.entries(x.dictURLs).map(([a, e]) => x.loadDictCategoryBuffers(e));
  ...
  load(r) {
    ...
    x.dictURLs || x.generateDictUrls(Sr), x.loadAllDictUrls().then((a) => {
      ...
      t.loadTrie(...e.trie), t.loadTokenInfoDictionaries(...e.tokenInfo), t.loadConnectionCosts(...e.connectionCost), t.loadUnknownDictionaries(...e.unknown), r(null, t);
    }).catch((a) => {
